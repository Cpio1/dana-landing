...
export const siteContent: SiteContent = {
  brand: {
    name: "ЖШС “Детский ясли сад “Дана 2009” бөбекжай балабақшасы",
    shortName: "«Дана 2009»",
  },
  nav: [
  ...
  activities: {
    ...
    items: [
      ...
      },
      {
        ...
        image: {
          src: "/photo/mektep.jpeg",
          alt: "Мектепке дайындық тобының тәрбиеленушісі өз қолымен жасаған жұмысымен",
          // Тік (портрет) фото — кескін 4:3 карточкада баланың беті көрінетіндей жоғарырақ орналасады.
  ...
  footer: {
    description:
      "ЖШС “Детский ясли сад “Дана 2009” бөбекжай балабақшасы — балаларға жылу, қамқорлық және даму.",
